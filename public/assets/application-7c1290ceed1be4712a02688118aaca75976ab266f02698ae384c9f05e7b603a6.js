...
(function() {
  ...
  $(function() {
    var sideMenu;
    return sideMenu = new Ui.Views.SideMenu({
      el: $('.js-side-menu')
    });
  });

  Ui.Views.SideMenu = (function(superClass) {
    ...
    SideMenu.prototype.toggleMenu = function(event) {
      return this.innerMenu.fadeToggle();
    };

    SideMenu.prototype.closeMenu = function(event) {
      return this.innerMenu.fadeOut();
    };
